...
jsts/Heizöltankung/stringValue1 2024-12-10T13:00:00.0000000 Tankung Stadler 3000l
...
#### or ```Load <Name>: <measurement> NewestOnly```
 ...
 - ```<from>```, ```<to>``` timerange to load (only UTC! e.g. "2015-01-01T16:30:41" or relative: e.g. "now/h" or "now-1d/d")
...
##### Examples
- ```Expr MinVorlauf: "Aussen.StartTime.Hour >= 18 ? 17 : 37"``` - Logik abhängig von der Zeit des Datenpunkts
