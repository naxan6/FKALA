...
//        public void Import(string filePath, bool locking = true)
//        {
...
//                ImportLine(line, locking);
//                percent = 1.0m * sr.BaseStream.Position / gesamt;
//                if (percent * 100 % 1 == 0)
//                {
//                    Console.WriteLine($"Progress {percent}% for Import {filePath}");
//                }
//            }
//        }

//        public void ImportLine(string line, bool locking = true)
//        {
